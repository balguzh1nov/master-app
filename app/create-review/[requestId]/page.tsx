...
export default function CreateReview({ params }: { params: Promise<{ requestId: string }> }) {
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 lg:px-8 py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Оставить отзыв</h1>
